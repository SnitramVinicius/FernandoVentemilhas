...
<main className="min-h-screen bg-[#06092b] relative">
 ...
 <div className="flex justify-center items-center w-full h-screen">
  <img src="/Logo2.png" alt="" className="w-6xl 2xl:w-7xl"/>
</div>
</main>
  ...
  <div className="bg-[#16162d] w-full max-w-[900px] lg:max-w-[1000px] 2xl:max-w-[1200px] rounded-2xl flex flex-col md:flex-row justify-center items-center p-5 gap-5 transition-all duration-300">
...
Conte comigo para representar e orientar você em todas as etapas do seu processo.
      ...
      <section
  id="areas"
  className="w-full min-h-screen flex flex-col items-center justify-center px-4 py-8 bg-[#16162d] relative"
>
  <img
  src="/background.jpg"
  alt="Perfil"
...
<div className="flex flex-wrap justify-center gap-4 object-cover z-10">
  ...
  <div className="bg-[#16162d] p-6 rounded-xl shadow-md w-full sm:flex-1 sm:min-w-[280px] sm:max-w-[350px] h-auto flex flex-col items-center px-10">
    ...
    <section id="contato" className="bg-[#16162d] w-full min-h-100 flex flex-col items-center justify-center px-4 py-8">
